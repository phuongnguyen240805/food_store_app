...
<head>
    ...
    <!-- Favicon -->
    <link href="/workspace/minimart/public/img/favicon.ico" rel="icon">
    ...
    <link rel="stylesheet" href="/workspace/minimart/public/css/footer.css">
</head>
<style>
    .container-bg {
...
<body>
    ...
    <!-- Footer Start -->
    <div class="container-fluid container-bg bg-dark footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
