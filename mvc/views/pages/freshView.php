        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-lg-6">
                <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s"
                    ...
                    <h1 class="display-5 mb-3">Thịt</h1>
            ...
            <div id="tab-1" class="tab-pane fade show p-0 active">
                <div class="row g-4">
                    ...
                    <div class="container-pages">
                        ...
                        <form id="pagination__form" action="<?php echo BASE_URL ?>product/fresh" method="post">
                            ...
                            <!-- Hiển thị số trang -->
                            <?php for ($i = 1; $i <= $data['freshPage']; $i++) { ?>
                                <input type="submit" name="page" value="<?php echo $i; ?>" class="page" />
                            <?php } ?>

                            <!-- next -->
                            <?php if ($page < $data['freshPage']): ?>
